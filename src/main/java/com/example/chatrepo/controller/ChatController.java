...
import com.example.chatrepo.dto.Message;
...
public class ChatController {
    ...
    public ResponseEntity<ChatHistoryRes> getChatHistory(@PathVariable Long chatRoomId) {
        ChatHistoryRes chatHistory = chatService.getChatHistory(chatRoomId);
